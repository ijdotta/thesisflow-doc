...
Un caso típico de uso por parte de la secretaría se da cuando el Consejo Departamental aprueba un nuevo proyecto final o tesis. El personal administrativo ingresa al módulo de administración, crea el proyecto registrando título, resumen, carrera y tipo de trabajo, y asocia a los docentes y estudiantes correspondientes. A partir de ese momento, el proyecto queda incorporado al registro histórico y pasa a formar parte de las estadísticas y visualizaciones disponibles.

\subsection*{Ejemplo de uso por docentes}

Desde la perspectiva de los docentes, la plataforma permite revisar y completar la información asociada a los proyectos en los que participan. Por ejemplo, una vez finalizado un proyecto, el director puede ingresar al sistema, actualizar los metadatos finales (fechas definitivas, calificación, palabras clave) y adjuntar el archivo con la memoria del trabajo mediante un enlace o recurso asociado. De este modo, se garantiza que la información publicada refleje con precisión la producción reciente del docente y de sus dirigidos.

\subsection*{Ejemplo de uso por estudiantes}

Un estudiante próximo a iniciar su proyecto final o tesis puede acceder al portal público, filtrar por carrera y temática (por ejemplo, sistemas distribuidos) y visualizar la evolución de proyectos en esa área. A partir de allí, identifica qué docentes dirigen más trabajos relacionados y revisa títulos y resúmenes de proyectos previos, obteniendo insumos concretos para formular una propuesta viable y ubicar un potencial director.
